...
const ListWithDropdown = () => {
    ...
    return (
        <div className="relative">
            <div className='flex justify-center items-center justify-center my-2'>
                <Dropdown onSortChange={handleSortChange} />
            </div>


            {loading && (<div role="status" className='flex justify-center items-center justify-center my-2'>
